...
public class TableElasticsearchMapStore implements MapStore<String, Table>, Serializable {
    public static final String TABLE_META_INDEX = "table-meta";
    public static final String TABLE_META_TYPE = "table-meta";
    private static final Logger logger = LoggerFactory.getLogger(TableElasticsearchMapStore.class.getSimpleName());
    private static ElasticsearchConnection elasticsearchConnection;
    private final ObjectMapper objectMapper;

    public TableElasticsearchMapStore(ElasticsearchConnection elasticsearchConnection) {
    ...
    public static class Factory implements MapStoreFactory<String, Table>, Serializable {
        ...
        public Factory(ElasticsearchConnection elasticsearchConnection) {
            TableElasticsearchMapStore.elasticsearchConnection = elasticsearchConnection;
        }

        @Override
        public TableElasticsearchMapStore newMapStore(String mapName, Properties properties) {
            return new TableElasticsearchMapStore(elasticsearchConnection);
        }
    }
}
