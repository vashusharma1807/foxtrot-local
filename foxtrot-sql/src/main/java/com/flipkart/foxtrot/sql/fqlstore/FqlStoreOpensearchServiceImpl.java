...
import static com.flipkart.foxtrot.core.querystore.impl.OpensearchUtils.DOCUMENT_TYPE_NAME;
 ...
 ***/
@Singleton
public class FqlStoreOpensearchServiceImpl implements FqlStoreService {

    public static final String FQL_STORE_INDEX = "fql-store";

    private static final Logger logger = LoggerFactory.getLogger(FqlStoreOpensearchServiceImpl.class);

    private final OpensearchConnection opensearchConnection;
    private final ObjectMapper objectMapper;

    @Inject
    public FqlStoreOpensearchServiceImpl(OpensearchConnection opensearchConnection,
