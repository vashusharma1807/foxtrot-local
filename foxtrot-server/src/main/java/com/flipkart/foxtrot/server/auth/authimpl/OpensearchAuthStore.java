 ...
 */
@Slf4j
public class OpensearchAuthStore implements AuthStore {
    ...
    @Inject
    public OpensearchAuthStore(OpensearchConnection connection,
                               ObjectMapper mapper) {
    ...
    public boolean deleteUser(String userId) {
        boolean status = connection.getClient()
                .delete(new DeleteRequest(USERS_INDEX, userId).setRefreshPolicy(
    ...
    public boolean deleteExpiredTokens(Date date,
        ...
        val deletedCount = connection.getClient()
                .deleteByQuery(
                        new DeleteByQueryRequest(TOKENS_INDEX).setIndicesOptions(IndicesOptions.lenientExpandOpen())
